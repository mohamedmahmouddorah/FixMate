      ...
      builder: (context, _) {
        ...
        if (_searchQuery.isNotEmpty) {
          ...
          displayProducts = displayProducts.where((p) =>
            p.title.toLowerCase().contains(query) || p.brand.toLowerCase().contains(query)
          ).toList();
        }
        ...
        return Scaffold(
                ...
                children: [
                  UserAccountsDrawerHeader(
                    ...
                    currentAccountPicture: CircleAvatar(
                      backgroundColor: isDark ? Colors.blueGrey[800] : Colors.grey[400],
                      child: Icon(Icons.person, color: isDark ? Colors.white70 : Colors.white, size: 40),
                    ),
                    accountName: Text(
                    ...
                    accountEmail: Text(
                      AuthService.instance.currentUserEmail ?? 'Welcome to FixMate',
                      ...
                      children: [
                        ...
                        ListTile(
                          leading: Icon(
                            ...
                            color: AuthService.instance.isGuest ? Colors.green : Colors.redAccent,
                          ),
                          title: Text(
                            AuthService.instance.isGuest ? 'Sign In / Login' : 'Logout',
                  ...
                  background: Container(
                    ...
                    child: Center(
                      child: Opacity(
                        opacity: 0.05,
                        child: Icon(
                          _categories.firstWhere((c) => c['name'] == _selectedCategory, orElse: () => _categories[0])['icon'],
                          size: 150,
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        ...
                        return ProductCard(
                          ...
                          onTap: () {},
                          onFavoriteToggle: () => AppController.instance.toggleFavorite(product.id),
                        );
                      },
          ...
          floatingActionButton: (AuthService.instance.isAdmin || AuthService.instance.isTechnician) ? null : FloatingActionButton(
